...
#ifdef __VMS
#define kwsysSystem_Shell_GetArgumentForUnix \
   kwsysSystem_Shell_UnixGA
#define kwsysSystem_Shell_GetArgumentSizeForUnix \
   kwsysSystem_Shell_UnixGAS
#define kwsysSystem_Shell_GetArgumentForWindows \
   kwsysSystem_Shell_WindowsGA
#endif
